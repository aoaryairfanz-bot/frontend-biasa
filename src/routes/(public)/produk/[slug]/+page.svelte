        ...
        <div class="container mx-auto px-4 max-w-7xl">
            <div class="flex flex-col md:flex-row gap-8 md:gap-12">
                ...
                <div class="flex-1 flex flex-col min-w-0 pt-2">
                    ...
                    <div class="mb-8 bg-gray-50 p-4 rounded-xl flex gap-3 items-start">
                        <MapPinIcon class="text-[#C4161C] mt-0.5 shrink-0" size="18"/>
                        <div>
                            <div class="text-sm font-bold text-gray-900">{centralBranch.name}</div>
                            <div class="text-xs text-gray-500 mt-1 leading-relaxed">{centralBranch.address}</div>
                        </div>
                    </div>
